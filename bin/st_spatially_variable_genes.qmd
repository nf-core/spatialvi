...
output_csv = "st_spatially_variable_genes.csv"  # Output: gene list
output_adata = "st_adata_spatially_variable_genes.h5ad"  # Output: AnnData file
output_sdata = "st_sdata.zarr"  # Output: SpatialData file
```
...
```{python}
st_adata.uns["moranI"].to_csv(os.path.join(artifact_dir, output_csv))
```
