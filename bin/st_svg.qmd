...
output_adata_svg = "st_adata_svg.h5ad"  # Name of the output anndata file
output_sdata = "st_sdata_svg.zarr"  # Name of the input anndata file
output_spatial_degs = "st_svg.csv"
...
```{python}
st_adata.uns["moranI"].to_csv(output_spatial_degs)
```