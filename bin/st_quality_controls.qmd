...
input_adata = None  # Name of the h5ad file
min_counts = 500  # Min counts per spot
min_genes = 250  # Min genes per spot
min_spots = 1  # Min spots per gene
output_adata = "st_adata_norm.h5ad"  # Name of the normalized data save file
```
...
if (n_genes_filtered_min_spots == 0 or n_spots_filtered_min_genes == 0):
