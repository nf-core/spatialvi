...
and your biological knowledge of the sample at hand.
...
# Print results
Markdown(f"""
- Removed `{n_spots - n_spots_filtered_mito}` spots with more than `{mito_threshold}%` mitochondrial content.
- Removed `{n_spots - n_spots_filtered_ribo}` spots with less than `{ribo_threshold}%` ribosomal content.
""")
```
