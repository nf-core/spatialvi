...
parser = argparse.ArgumentParser(
    description='Preprocess spatial traqnscriptomics data.')
...
parser.add_argument('--pltFigSize',
                    ...
                    default=6,
                    help='Figure size.')
parser.add_argument('--stQCinName',
                    metavar='name',
                    type=str,
                    default='st_QC_in.png',
                    help='Figure name.')
parser.add_argument('--stQCoutName',
                    metavar='name',
                    type=str,
                    default='st_QC_out.png',
                    help='Figure name.')
...
parser.add_argument('--histogramPlotAllName',
                    metavar='name',
                    type=str,
                    default='st_histogrtam_all.png',
                    help='Figure name.')
parser.add_argument('--histogramPlotOutName',
                    metavar='name',
                    type=str,
                    default='st_histogrtam_out.png',
                    help='Figure name.')
