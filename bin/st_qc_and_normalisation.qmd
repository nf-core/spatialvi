...
spatial data. The following plots show the distribution of the number of genes
per counts and counts per spot, as well as the percentage of counts from
...
It is also useful to some of these quality metrics against each other, such as
mitochondrial versus ribosomal content and the total counts versus the number of
genes:
