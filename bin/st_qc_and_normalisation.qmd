...
We filter cells based on minimum counts and genes, but also filter genes based
on minimum cells; exactly what filtering criteria is reasonable is up to you and
