...
- Removed `{Number_genes - Number_genes_filtered_minCells}` genes expressed in less than `{minCells}` spots.
- A total of `{Number_spots_filtered_minGenes}` spots out of `{Number_spots}` remain after filtering.
- A total of `{Number_genes_filtered_minCells}` genes out of `{Number_genes}` remain after filtering.
""")
```
