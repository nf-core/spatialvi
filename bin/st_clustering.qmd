...
Markdown(f"Resolution for Leiden clustering: `{resolution}`")
```
...
sc.pl.spatial(st_adata, img_key="hires", color="total_counts")
sc.pl.spatial(st_adata, img_key="hires", color="n_genes_by_counts")
```
...
```{python}
# TODO nf-core: Can the colour bar on this figure be fit to the figure?
plt.rcParams["figure.figsize"] = (7, 7)
