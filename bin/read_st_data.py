...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_sdata", metavar="output_sdata", type=str, default=None, help="Output spatialdata zarr path.")
    #TODO Add argument with meta.id for dataset_id
    
    args = parser.parse_args()

    # Read Visium data
    st_spatialdata = spatialdata_io.visium(args.SRCountDir, counts_file ="raw_feature_bc_matrix.h5", dataset_id ="visium")
