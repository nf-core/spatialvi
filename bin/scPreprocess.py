...
parser.add_argument(
    "--histogramPlotAllName", metavar="name", type=str, default="sc_histogrtam_all.png", help="Figure name."
)
parser.add_argument(
    "--histogramPlotFilteredName", metavar="name", type=str, default="sc_histogrtam_filtered.png", help="Figure name."
)
parser.add_argument(
    "--histWithWithoutNorm",
    metavar="name",
...
parser.add_argument(
    "--nameVar", metavar="File name", type=str, default="sc_adata.var.csv", help="Name of the features file."
)
parser.add_argument(
    "--nameObs", metavar="File name", type=str, default="sc_adata.obs.csv", help="Name of the observations file."
)
parser.add_argument(
    "--nameDataPlain", metavar="File name", type=str, default="sc_adata_plain.h5ad", help="Name of the data save file."
)
parser.add_argument(
    "--nameDataNorm", metavar="File name", type=str, default="sc_adata_norm.h5ad", help="Name of the data save file."
)
...
histplotQC(
    sc_adata.obs["total_counts"][sc_adata.obs["total_counts"] < args.histplotQCmaxTotalCounts],
    bins=args.histplotQCbins,
    ax=axs[1],
)
histplotQC(sc_adata.obs["n_genes_by_counts"], bins=args.histplotQCbins, ax=axs[2])
histplotQC(
    sc_adata.obs["n_genes_by_counts"][sc_adata.obs["n_genes_by_counts"] < args.histplotQCminGeneCounts],
    bins=args.histplotQCbins,
    ax=axs[3],
)
